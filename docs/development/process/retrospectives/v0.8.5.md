...
### Pragmatic Scoping
Recognized that full Kuzu integration and LLM-based relationship extraction were too complex for a single release. SQLite-backed graph with pattern-based extraction provides 80% of the value with 20% of the complexity.
...
This limits immediate usability but keeps the implementation focused.
