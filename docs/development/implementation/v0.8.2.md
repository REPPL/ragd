...
v0.8.2 enhances retrieval quality with Cross-Encoder Reranking (F-080) and Query Decomposition (F-081). These features improve precision for complex queries without changing the indexing pipeline.
...
- `docs/development/features/completed/F-080-cross-encoder-reranking.md`
- `docs/development/features/completed/F-081-query-decomposition.md`
