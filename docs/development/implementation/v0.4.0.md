...
2. **ColPali as Primary Vision Model:** Chose ColPali/ColQwen2 for document-focussed vision understanding. These models excel at understanding document pages, diagrams, and charts compared to general-purpose vision models.
