...
## Deferred to v0.8.x (Now Completed)

The following features were originally scoped for v0.7.0 but deferred to maintain focussed delivery. They were later implemented in v0.8.x:

| Feature | Description | Implemented In |
|---------|-------------|----------------|
| [F-018](../features/completed/F-018-data-tiers.md) | Data Sensitivity Tiers | v0.8.0 |
| [F-064](../features/completed/F-064-tag-provenance.md) | Tag Provenance | v0.8.0 |
| [F-061](../features/completed/F-061-auto-tag-suggestions.md) | Auto-Tag Suggestions | v0.8.1 |
| [F-062](../features/completed/F-062-tag-library.md) | Tag Library Management | v0.8.1 |
| [F-063](../features/completed/F-063-smart-collections.md) | Smart Collections | v0.8.1 |
...
| [F-075](../features/completed/F-075-backend-migration-tool.md) | Backend Migration Tool | Alternative if dual-index not chosen |
