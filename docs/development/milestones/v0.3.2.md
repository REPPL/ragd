...
|----------|-------------|--------|
| Tag Origin Tracking | Know if a tag was added manually or auto-generated | 📋 Planned |
| Auto-Tag Review | Identify unconfirmed auto-tags for review | 📋 Planned |
| Quality Metrics | Track auto-tag accuracy over time | 📋 Planned |
| Bulk Tag Management | Remove all auto-tags without affecting manual ones | 📋 Planned |

## Features Included

| Feature | Description | Status |
|---------|-------------|--------|
| [F-064](../features/completed/F-064-tag-provenance.md) | Tag Provenance Schema | ✅ Complete (v0.8.0) |
...
- [F-064: Tag Provenance](../features/completed/F-064-tag-provenance.md) - Feature specification (implemented in v0.8.0)
...
**Status**: Superseded (F-064 implemented in v0.8.0)
