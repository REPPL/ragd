...
|----|---------|-------------|
| F-200 | Plugin System | Extensibility framework |
| F-202 to F-205 | Dashboard & Tools | Advanced UI, saved searches, export templates |

## v3.0 Features (Privacy Foundation)

| ID | Feature | Research |
|----|---------|----------|
| [F-059](./F-059-embedding-privacy-protection.md) | Embedding Privacy | [State-of-the-Art PII Removal](../../research/state-of-the-art-pii-removal.md) |
...
| F-300 to F-302 | Privacy Foundation | Dashboard, lineage, anonymisation |
