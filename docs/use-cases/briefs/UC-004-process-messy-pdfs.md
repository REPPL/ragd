...
Example of 'messy' PDFs: A scan of an old book, either as a single PDF file or as a collection of PDFs in a single directory. Pages may or may not be in order (e.g., page x, xi, 1, 2, 3). Some pages may have page numbers while others don't. Some scanned pages may be upside down or rotated by 90 degrees.
